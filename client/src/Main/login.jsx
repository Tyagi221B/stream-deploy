...
function Login({ setloginpop }) {
  ...
  const firebaseConfig = {
    ...
    // apiKey: "AIzaSyC_Xts6TrLQ0NRdEC2P7P4BtgckrDe48TE",
    // authDomain: "streamon-df1af.firebaseapp.com",
    // projectId: "streamon-df1af",
  };
  ...
  function loginwithemail(e) {
    ...
    firebase
      ...
      .then((userCredential) => {
        popup("success", "Login Success! Enjoy StreamOn");
        setloginpop();
      })
      .catch((error) => {
        popup(
          "question",
          "Unable to Login ,make sure you have created a account"
        );
      });
  }
  function createwithemail(e) {
    ...
    firebase
      ...
      .catch((error) => {
        popup(
          "question",
          "Unable to Create Account , Please try again or make sure user does't exists."
        );
      });
  }
  return (
    <div className="loginpop">
      ...
      <div className="loginpopdiv">
        ...
        />
        <h1 className="h1text">
          Continue <span>StreamOn</span> With
        </h1>
        <div className="logicon">
          ...
          >
            <AiOutlineTwitter style={{ color: "#00b0ff" }} />
          </div>
        </div>
          ...
          <>
            ...
            >
              ...
              <div className="subbut">
                <Button colorScheme="red" type="submit" variant="outline">
                  Continue
                </Button>
              </div>
            </form>
