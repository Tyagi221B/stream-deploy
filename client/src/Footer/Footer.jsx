    ...
    return(
        ...
        <footer className="hero">
          <div className="container flex">
            ...
            <h2>About Me</h2>
            <p>
            A Team of software developer, starting There professional life, This is a sample website of our work and we will create more like this website , on this website you will get all movies .
            </p>
          </div>
          <div className="container-pages flex">
            <div className="container__recentpages">
                <h2>StreamOn</h2>
                <ul>
                    <li><Link to="/">Asmit</Link></li>
                </ul>
                <ul>
                    <li><Link to="/search/1/movies">Pranav</Link></li>
                </ul>
                <ul>
                    <li><Link to="/movies">Dilpreet</Link></li>
                </ul><ul>
                    <li><Link to="/webseries">Kartik</Link></li>
                </ul>
                <ul>
                    <li><Link to="/My List">Bhagwan</Link></li>
                </ul>    
            </div>
            <div className="container__more">
                <h2>Contact US</h2>
                <ul>
                    <li><a href="https://www.instagram.com/asmit_tyagi/">Instagram</a></li>
                </ul>
                <ul>
                    <li><a href="https://github.com/Tyagi221B">Github</a></li>
                </ul><ul>
                    <li><a href="https://www.linkedin.com/in/asmit-tyagi-0482081ba/">LinkedIn</a></li>
                </ul>
                <ul>
                    <li><a href="ashmittyagigms@gmail.com">Email</a></li>
                </ul>
                <ul>
